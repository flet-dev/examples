...
def example():
    ...
    def change_primary_color(e):
        container.theme=ft.Theme(color_scheme=ft.ColorScheme(primary=primary_color.value))
        primary_color.value = ""
        container.update()
    ...
    return ft.Column(controls=[
        ...
        ft.Row(controls=[
            primary_color,
            ft.FilledButton(text="Change Primary color in Container", on_click=change_primary_color)
        ]),
    ])