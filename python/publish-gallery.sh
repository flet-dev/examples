...
flet publish python/apps/icons-browser/main.py --distpath python/dist/todo --base-url icons-browser --pre --app-name "Flet Icons Browser" --app-description "Quickly search through icons collection to use in your app."
